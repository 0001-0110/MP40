...
namespace MP40.BLL.Mapping
{
	public class BijectiveProfile : Profile
	{
		...
		public void CreateBijectiveMap<TSource, TDestination>()
		{
			...
			CreateBijectiveMap<TSource, TDestination>(mapping => mapping, mapping => mapping);
		}
		...
		{
			CreateBijectiveMap(customization, mapping => mapping);
		}

		public void CreateBijectiveMap<TSource, TDestination>(Func<IMappingExpression<TDestination, TSource>, IMappingExpression<TDestination, TSource>> reverseCustomization)
		{
			CreateBijectiveMap(mapping => mapping, reverseCustomization);
		}

		public void CreateBijectiveMap<TSource, TDestination>(Func<IMappingExpression<TSource, TDestination>, IMappingExpression<TSource, TDestination>> customization, Func<IMappingExpression<TDestination, TSource>, IMappingExpression<TDestination, TSource>> reverseCustomization)
		{
			...
			reverseCustomization(customization(mapping).ReverseMap());
		}
	}
}
